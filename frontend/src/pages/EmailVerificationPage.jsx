...
const EmailVerificationPage = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const token = res.user.resetPasswordToken
		...
		<div className="flex items-center justify-center min-h-screen">
			<div className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'>
				<motion.div
					...
					className='bg-opacity-50 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full max-w-md'
				>
					...
					<p className='text-center text-gray-300 mb-6'>Enter the 6-digit code sent to your siswa email address.</p>
